...
import pl.motyczko.scrollheader.CarouselPagerAdapter;

public class PagerAdapter extends CarouselPagerAdapter {
    ...
    public CharSequence getPageTitle(int position) {
        switch (position) {
            case 0: return "Howl's Moving Castle";
            case 1: return "Tales from Earthsea";
            case 2: return "Spirited Away";
            case 3: return "My Neighbour Totoro";
            case 4: return "Castle in the Sky";
            case 5: return "Princess Mononoke";
            default: return "";
        }
    }

    /**
     * used only in CarouselActivity
     *
     * @param position
     * @return
     */
    public int getPageHeaderImageResource(int position) {
        switch (position) {
            case 0: return R.drawable.howls_moving_castle;
            case 1: return R.drawable.tales_from_earthsea;
            default: return -1;
        }
    }
}
